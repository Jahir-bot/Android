    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnIngresar: {
                ...
                switch (option) {
                    case 0:{
                        Snackbar.make(v,"Seleccione una opción por favor",Snackbar.LENGTH_LONG).show();
                    }break;
                    case 1: {
                        Intent op1 = new Intent(getApplicationContext(), IndentificaNumeroActivity.class);
                        startActivity(op1);
                    }
                    break;
                    case 2: {
                        Intent op2 = new Intent(getApplicationContext(), CalculoHipotenusaActivity.class);
                        startActivity(op2);
                    }
                    break;
                    case 3: {
                        Intent op3 = new Intent(getApplicationContext(), DeterminaCalificacionActivity.class);
                        startActivity(op3);
                    }
                    break;
                    case 4: {
                        Intent op4 = new Intent(getApplicationContext(), CalculadoraActivity.class);
                        startActivity(op4);
                    }
                    break;
                    case 5: {
                        Intent op5 = new Intent(getApplicationContext(), PromedioSimple1Activity.class);
                        startActivity(op5);
                    }
                    break;
                    case 6: {
                        Intent op6 = new Intent(getApplicationContext(), PromedioSimple2Activity.class);
                        startActivity(op6);
                    }
                    break;
                    case 7: {
                        Intent op7 = new Intent(getApplicationContext(), OrdenaMayorMenorActivity.class);
                        startActivity(op7);
                    }
                    break;
                    case 8: {
                        Intent op8= new Intent(getApplicationContext(),OrdenaMenorMayorActivity.class);
                        startActivity(op8);
                    }
                    break;
                    case 9: {
                        Intent op9=new Intent(getApplicationContext(),CambioDolaresActivity.class);
                        startActivity(op9);
                    }break;
                    case 10:{
                        Intent op10=new Intent(getApplicationContext(),VelocidadAutoActivity.class);
                        startActivity(op10);
                    }break;
                }
            }
